...
def test_principal_vs_time_plot():
    actual_plot = principal_vs_time_plot(300_000, 3.0, 30, 'Percentage', 10, datetime.date(2020, 1, 1))
    actual_data = actual_plot.data[('Curve', 'Principal_Paid')].data.loc[0:4, 'Principal Paid'].round(2)
